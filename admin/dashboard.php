...
<section class="dashboard">
   ...
   <div class="box">
      ...
      <a href="update_profile.php" class="btn">profili guncelleme</a>
   </div>
   ...
   <div class="box">
      ...
      <p>total bekleyenler</p>
      <a href="placed_orders.php" class="btn">siparislere gor</a>
   </div>
   <?php } ?>
