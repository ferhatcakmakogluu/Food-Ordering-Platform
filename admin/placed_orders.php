...
<section class="placed-orders">
   ...
   <div class="box">
      ...
      <p> total urunler : <span><?= $fetch_orders['total_products']; ?></span> </p>
      <p> total fiyat : <span>$<?= $fetch_orders['total_price']; ?>/-</span> </p>
      <p> odeme yontemi : <span><?= $fetch_orders['method']; ?></span> </p>
